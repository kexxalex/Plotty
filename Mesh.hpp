...
public:
     ...
     * @param T name of the column used as time or uniform delta_t
    ...
    Mesh(std::vector<float> &&positions, u32 stride, GLenum mode);
     ...
     */
    virtual glm::fmat4 getOrthonormalFrame(float t) const;
    ...
    virtual glm::fvec4 transform(float t, const glm::fvec4 &direction) const;
    virtual glm::fvec4 transform(const glm::fvec2 &local, const glm::fvec4 &direction) const;

    virtual glm::fvec3 at(float t) const;
    virtual glm::fvec3 diffAt(float t) const;
    virtual glm::fvec3 diff2At(float t) const;
